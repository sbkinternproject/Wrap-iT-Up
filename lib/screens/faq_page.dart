            ...
            children: <Widget>[
              ...
              ...panels
                  .map((panel) => ExpansionTile(
                          // Creates a single-line [ListTile] with an expansion arrow
                          //icon that expands or collapses the tile to reveal or hide
                          //the [children]. The [initiallyExpanded] property must be
                          //non-null.
                          title: Text(
                            panel.title,
                            style: TextStyle(
