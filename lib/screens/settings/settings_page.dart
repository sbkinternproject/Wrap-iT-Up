  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      ...
      child: Scaffold(
        ...
        body: SafeArea(
          bottom: true,
          // In Flutter, LayoutBuilder Widget is similar to the Builder widget
          //except that the framework calls the builder function at layout time
          //and provides the parent widget's constraints. This is useful when
          //the parent constrains the child's size and doesn't depend on the
